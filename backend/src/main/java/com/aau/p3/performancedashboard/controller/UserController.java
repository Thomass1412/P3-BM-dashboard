...
public class UserController {
        ...
        public Mono<ResponseEntity<MessageResponse>> deleteUserById(
                        @PathVariable(value = "userId") @Parameter(description = "ID of the user to delete", example = "605c147c4f7d4a4b3c77ba92") String userId) {
                return userService.deleteUserById(userId)
                                .then(Mono.just(new ResponseEntity<MessageResponse>(
                                                new MessageResponse("User deleted successfully"), HttpStatus.OK)))
                                .onErrorResume(e -> Mono.just(new ResponseEntity<MessageResponse>(
        ...
        public Mono<ResponseEntity<UserResponse>> setUserAccess(
                        ...
                        @Parameter(description = "ID of the user to upgrade", example = "605c147c4f7d4a4b3c77ba92") String userId,
                        @RequestParam
                        @Parameter(description = "New role for the user", example = "ROLE_AGENT") String newRole,
                        Authentication authentication) {
