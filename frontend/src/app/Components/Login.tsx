...
function Login() {
    ...
    return (
        <form className="relative ">
          ...
          <input id="password" className="w-full bg-transparent mb-4 text-black py-1 px-2 border-solid border-b-2 border-green-700 focus:outline-none" placeholder="Password" />
