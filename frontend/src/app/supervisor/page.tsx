        ...
        <main className="bg-green-50 grid h-screen grid-cols-8 grid-rows-6 gap-4">
            <div className="bg-green-700 col-span-8 grid grid-cols-8 grid-rows-2 gap-2">
                ...
                <div className="col-span-1">
                    <a className="flexCenterC justify-center w-1/2 bg-green-50 rounded-2xl my-1 text-black" href="/login">
                        <h1 className="text-sm font-extrabold text-black">profile</h1> 
                    </a>
                    <a className="flexCenterC justify-center w-1/2 bg-green-50 rounded-2xl my-1 text-black" href="/login">
                        <h1 className="text-sm font-extrabold text-black">sign out</h1> 
                    </a>
                </div>
                ...
                <a className="flexCenterC justify-center col-span-1 bg-green-50 rounded-2xl my-1 text-black" href="/login">
                    <h1 className="text-sm font-extrabold text-black">Manage users</h1> 
                </a>
                <a className="flexCenterC justify-center col-span-1 bg-green-50 rounded-2xl my-1 text-black" href="/login">
                    <h1 className="text-sm font-extrabold text-black">Metric</h1> 
                </a>
                <a className="flexCenterC justify-center col-span-1 bg-green-50 rounded-2xl my-1 text-black" href="/login">
                    <h1 className="text-sm font-extrabold text-black">Integrations</h1> 
                </a>
                <a className="flexCenterC justify-center col-span-1 bg-green-50 rounded-2xl my-1 text-black" href="/login">
                    <h1 className="text-sm font-extrabold text-black"></h1> 
                </a>
                <a className="flexCenterC justify-center col-span-1 bg-green-50 rounded-2xl my-1 text-black" href="/login">
                    <h1 className="text-sm font-extrabold text-black">sign out</h1> 
                </a>
